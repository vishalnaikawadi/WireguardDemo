 ...
 */
package com.hvn.wireguarddemo.wireguard.databinding
...
class ObservableKeyedRecyclerViewAdapter<K, E : Keyed<out K>> internal constructor(
    ...
    private fun getItem(position: Int): E? =
        if (list == null || position < 0 || position >= list!!.size) null else list?.get(position)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        ViewHolder(DataBindingUtil.inflate(layoutInflater, layoutId, parent, false))
    ...
    fun setRowConfigurationHandler(rowConfigurationHandler: RowConfigurationHandler<*, *>?) {
        ...
        this.rowConfigurationHandler =
            rowConfigurationHandler as? RowConfigurationHandler<ViewDataBinding, Any>
    }
    ...
    private class OnListChangedCallback<E : Keyed<*>> constructor(adapter: ObservableKeyedRecyclerViewAdapter<*, E>) :
        ...
        private val weakAdapter: WeakReference<ObservableKeyedRecyclerViewAdapter<*, E>> =
